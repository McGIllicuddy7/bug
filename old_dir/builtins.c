...
void user_put_str_double(double a){
    char buffer[100] = {0};
    snprintf(buffer, 99, "%lf", a);
    size_t l = strlen(buffer);
    write(1, buffer, l);
}
void user_put_str_ln_double(double a){
    char buffer[100] = {0};
    snprintf(buffer, 99, "%lf\n", a);
    size_t l = strlen(buffer);
    write(1, buffer, l);
}

double user_float_long(long a ){
    return a;
}
long user_int_double(double a ){
    return a;
}
